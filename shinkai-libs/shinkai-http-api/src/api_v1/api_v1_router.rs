...
//             .and(warp::post())
//             .and(warp::body::json::<ShinkaiMessage>())
//             .and_then(move |message: ShinkaiMessage| mark_as_read_up_to_handler(node_commands_sender.clone(),
// message))     };
...
//             .and(warp::post())
//             .and(warp::body::json::<ShinkaiMessage>())
//             .and_then(move |message: ShinkaiMessage| change_nodes_name_handler(node_commands_sender.clone(),
// message))     };
...
//             .and(warp::post())
//             .and(warp::body::json::<ShinkaiMessage>())
//             .and_then(move |message: ShinkaiMessage| get_my_subscribers_handler(node_commands_sender.clone(),
// message))     };
...
//             .and(warp::post())
//             .and(warp::body::json::<ShinkaiMessage>())
//             .and_then(move |message: ShinkaiMessage| scan_ollama_models_handler(node_commands_sender.clone(),
// message))     };
...
//             .and(warp::post())
//             .and(warp::body::json::<ShinkaiMessage>())
//             .and_then(move |message: ShinkaiMessage| add_ollama_models_handler(node_commands_sender.clone(),
// message))     };
...
//             .and(warp::post())
//             .and(warp::body::json::<ShinkaiMessage>())
//             .and_then(move |message: ShinkaiMessage| search_shinkai_tool_handler(node_commands_sender.clone(),
// message))     };
...
//             .and(warp::post())
//             .and(warp::body::json::<ShinkaiMessage>())
//             .and_then(move |message: ShinkaiMessage| get_workflow_info_handler(node_commands_sender.clone(),
// message))     };
...
//             .and(warp::post())
//             .and(warp::body::json::<ShinkaiMessage>())
//             .and_then(move |message: ShinkaiMessage| list_all_workflows_handler(node_commands_sender.clone(),
// message))     };
