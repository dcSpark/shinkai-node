...
use super::api_v2_handlers_tool_wallets::tool_wallets_routes;
...
pub fn v2_routes(
    ...
    let tool_wallets_routes = tool_wallets_routes(node_commands_sender.clone());
