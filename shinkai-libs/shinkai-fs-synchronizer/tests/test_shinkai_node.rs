#[cfg(test)]
mod tests {
    use shinkai_file_synchronizer::shinkai_manager::{DeviceKeys, ShinkaiManager};
    ...
    fn test_decrypt_message_with_passphrase() {
        let unencrypted_keys = DeviceKeys {
        ...
        let decrypted_result = ShinkaiManager::decrypt_exported_keys(encrypted_body, passphrase);
        assert!(
    ...
    #[test]
    fn test_initialize_from_encrypted_export_as_standalone() {
        // Set up the environment variables as expected by the function
        env::set_var("ENCRYPTED_KEYS", "encrypted:");

        env::set_var("ENCRYPTION_PASSPHRASE", "password123$");

        let result = ShinkaiManager::initialize_from_encrypted_file();
        assert!(result.is_ok(), "Shinkai manager initialization failed");

        env::remove_var("ENCRYPTED_KEYS");
        env::remove_var("ENCRYPTION_PASSPHRASE");
    }

    #[test]
    fn test_initialize_as_lib() {
        let unencrypted_keys = DeviceKeys {
            my_device_encryption_pk: "5fd7f565d45cd9245e54b6b54e42c0bc556187962f458385652751fbbc58f079".to_string(),
            my_device_encryption_sk: "08c8e480eece95571fb3655216665ca71b92a64392d1da43555d49b65505bf67".to_string(),
            my_device_identity_pk: "e7b2259353879f1e7f8c421b0f57ffc7aafa7a5f798cf342c995b111567319b9".to_string(),
        ...
        let result = ShinkaiManager::initialize(unencrypted_keys.clone());

        println!("Receiver Public Key: {}", hex::encode(result.receiver_public_key));
        println!("Node Signature PK: {}", unencrypted_keys.node_encryption_pk);

        assert_eq!(
            hex::encode(result.receiver_public_key),
            unencrypted_keys.node_encryption_pk
        );
