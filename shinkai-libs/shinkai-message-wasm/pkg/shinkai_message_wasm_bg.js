 ...
 * @returns {string}
 */
export function convert_encryption_sk_string_to_encryption_pk_string(
  encryption_sk
) {
  let deferred3_0;
  let deferred3_1;
  try {
    ...
    wasm.convert_encryption_sk_string_to_encryption_pk_string(
      retptr,
      ptr0,
      len0
    );
...
export class InboxNameWrapper {
  ...
  static get_regular_inbox_name_from_params(
    ...
    try {
      ...
      wasm.inboxnamewrapper_get_regular_inbox_name_from_params(
        retptr,
        ptr0,
        len0,
        ptr1,
...
export class JobMessageWrapper {
  ...
  constructor(job_id_js, content_js, files_inbox) {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.jobmessagewrapper_new(
        retptr,
        addBorrowedObject(job_id_js),
        addBorrowedObject(content_js),
        addBorrowedObject(files_inbox)
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      var r2 = getInt32Memory0()[retptr / 4 + 2];
  ...
  static fromStrings(job_id, content, files_inbox) {
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.jobmessagewrapper_fromStrings(
      ptr0,
      len0,
      ptr1,
      len1,
...
export class JobScopeWrapper {
  ...
  constructor(buckets_js, documents_js) {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.jobscopewrapper_new(
        retptr,
        addBorrowedObject(buckets_js),
        addBorrowedObject(documents_js)
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      var r2 = getInt32Memory0()[retptr / 4 + 2];
...
export class SerializedAgentWrapper {
  ...
  constructor(serialized_agent_js) {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.serializedagentwrapper_fromJsValue(
        retptr,
        addBorrowedObject(serialized_agent_js)
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      var r2 = getInt32Memory0()[retptr / 4 + 2];
  ...
  static fromStrings(
    ...
    try {
      ...
      const ptr8 = passStringToWasm0(
        allowed_message_senders,
        wasm.__wbindgen_malloc,
        wasm.__wbindgen_realloc
      );
      const len8 = WASM_VECTOR_LEN;
      wasm.serializedagentwrapper_fromStrings(
        retptr,
        ptr0,
        len0,
        ptr1,
...
export class ShinkaiMessageBuilderWrapper {
  ...
  constructor(
    ...
    try {
      ...
      const len2 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_new(
        retptr,
        ptr0,
        len0,
        ptr1,
  ...
  body_encryption(encryption) {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.shinkaimessagebuilderwrapper_body_encryption(
        retptr,
        this.__wbg_ptr,
        addHeapObject(encryption)
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      if (r1) {
  ...
  no_body_encryption() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.shinkaimessagebuilderwrapper_no_body_encryption(
        retptr,
        this.__wbg_ptr
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
  ...
  message_raw_content(message_raw_content) {
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_message_raw_content(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0
  ...
  message_schema_type(content) {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.shinkaimessagebuilderwrapper_message_schema_type(
        retptr,
        this.__wbg_ptr,
        addHeapObject(content)
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      if (r1) {
  ...
  internal_metadata(sender_subidentity, recipient_subidentity, encryption) {
    try {
      ...
      const len1 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_internal_metadata(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  internal_metadata_with_inbox(
    ...
    try {
      ...
      const len2 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_internal_metadata_with_inbox(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  internal_metadata_with_schema(
    ...
    try {
      ...
      const len2 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_internal_metadata_with_schema(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  empty_encrypted_internal_metadata() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.shinkaimessagebuilderwrapper_empty_encrypted_internal_metadata(
        retptr,
        this.__wbg_ptr
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
  ...
  empty_non_encrypted_internal_metadata() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.shinkaimessagebuilderwrapper_empty_non_encrypted_internal_metadata(
        retptr,
        this.__wbg_ptr
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
  ...
  external_metadata(recipient, sender) {
    try {
      ...
      const len1 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_external_metadata(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  external_metadata_with_intra(recipient, sender, intra_sender) {
    try {
      ...
      const len2 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_external_metadata_with_intra(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  external_metadata_with_other(recipient, sender, other) {
    try {
      ...
      const len2 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_external_metadata_with_other(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  external_metadata_with_other_and_intra_sender(
    ...
    try {
      ...
      const len3 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_external_metadata_with_other_and_intra_sender(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  external_metadata_with_schedule(recipient, sender, scheduled_time) {
    try {
      ...
      const len2 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_external_metadata_with_schedule(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  build_to_jsvalue() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.shinkaimessagebuilderwrapper_build_to_jsvalue(
        retptr,
        this.__wbg_ptr
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
  ...
  static ack_message(
    ...
    try {
      ...
      const len5 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_ack_message(
        retptr,
        ptr0,
        len0,
        ptr1,
  ...
  static request_code_registration(
    ...
    try {
      ...
      const len8 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_request_code_registration(
        retptr,
        ptr0,
        len0,
        ptr1,
  ...
  static use_code_registration_for_profile(
    ...
    try {
      ...
      const len8 = WASM_VECTOR_LEN;
      const ptr9 = passStringToWasm0(
        recipient,
        wasm.__wbindgen_malloc,
        wasm.__wbindgen_realloc
      );
      const len9 = WASM_VECTOR_LEN;
      const ptr10 = passStringToWasm0(
        recipient_subidentity,
        wasm.__wbindgen_malloc,
        wasm.__wbindgen_realloc
      );
      const len10 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_use_code_registration_for_profile(
        retptr,
        ptr0,
        len0,
        ptr1,
  ...
  static use_code_registration_for_device(
    ...
    try {
      ...
      const len10 = WASM_VECTOR_LEN;
      const ptr11 = passStringToWasm0(
        recipient,
        wasm.__wbindgen_malloc,
        wasm.__wbindgen_realloc
      );
      const len11 = WASM_VECTOR_LEN;
      const ptr12 = passStringToWasm0(
        recipient_subidentity,
        wasm.__wbindgen_malloc,
        wasm.__wbindgen_realloc
      );
      const len12 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_use_code_registration_for_device(
        retptr,
        ptr0,
        len0,
        ptr1,
  ...
  static initial_registration_with_no_code_for_device(
    ...
    try {
      ...
      const len7 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_initial_registration_with_no_code_for_device(
        retptr,
        ptr0,
        len0,
        ptr1,
  ...
  static get_last_messages_from_inbox(
    ...
    try {
      ...
      const len8 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_get_last_messages_from_inbox(
        retptr,
        ptr0,
        len0,
        ptr1,
  ...
  static request_add_agent(
    ...
    try {
      ...
      const len7 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_request_add_agent(
        retptr,
        ptr0,
        len0,
        ptr1,
   ...
   * @returns {string}
   */
  static get_all_availability_agent(
    my_subidentity_encryption_sk,
    my_subidentity_signature_sk,
    receiver_public_key,
    sender,
    ...
    try {
      ...
      const len6 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_get_all_availability_agent(
        retptr,
        ptr0,
        len0,
        ptr1,
  ...
  static read_up_to_time(
    ...
    try {
      ...
      const len8 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_read_up_to_time(
        retptr,
        ptr0,
        len0,
        ptr1,
   ...
   * @returns {string}
   */
  static create_custom_shinkai_message_to_node(
    my_subidentity_encryption_sk,
    my_subidentity_signature_sk,
    receiver_public_key,
    data,
    ...
    try {
      ...
      const len9 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_create_custom_shinkai_message_to_node(
        retptr,
        ptr0,
        len0,
        ptr1,
  ...
  static ping_pong_message(
    ...
    try {
      ...
      const len5 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_ping_pong_message(
        retptr,
        ptr0,
        len0,
        ptr1,
  ...
  static job_creation(
    ...
    try {
      ...
      const len6 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_job_creation(
        retptr,
        ptr0,
        len0,
        ptr1,
  ...
  static job_message(
    ...
    try {
      ...
      const len9 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_job_message(
        retptr,
        ptr0,
        len0,
        ptr1,
  ...
  static terminate_message(
    ...
    try {
      ...
      const len5 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_terminate_message(
        retptr,
        ptr0,
        len0,
        ptr1,
  ...
  static error_message(
    ...
    try {
      ...
      const len6 = WASM_VECTOR_LEN;
      wasm.shinkaimessagebuilderwrapper_error_message(
        retptr,
        ptr0,
        len0,
        ptr1,
...
export class ShinkaiMessageWrapper {
  ...
  constructor(shinkai_message_js) {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.shinkaimessagewrapper_fromJsValue(
        retptr,
        addBorrowedObject(shinkai_message_js)
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      var r2 = getInt32Memory0()[retptr / 4 + 2];
  ...
  set message_body(body) {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.shinkaimessagewrapper_set_message_body(
        retptr,
        this.__wbg_ptr,
        addHeapObject(body)
      );
  ...
  set external_metadata(external_metadata) {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.shinkaimessagewrapper_set_external_metadata(
        retptr,
        this.__wbg_ptr,
        addHeapObject(external_metadata)
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      if (r1) {
  ...
  new_with_empty_outer_signature() {
    const ret = wasm.shinkaimessagewrapper_new_with_empty_outer_signature(
      this.__wbg_ptr
    );
  ...
  new_with_empty_inner_signature() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.shinkaimessagewrapper_new_with_empty_inner_signature(
        retptr,
        this.__wbg_ptr
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
  ...
  inner_content_for_hashing() {
    ...
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.shinkaimessagewrapper_inner_content_for_hashing(
        retptr,
        this.__wbg_ptr
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
  ...
  calculate_blake3_hash_with_empty_outer_signature() {
    ...
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.shinkaimessagewrapper_calculate_blake3_hash_with_empty_outer_signature(
        retptr,
        this.__wbg_ptr
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
  ...
  calculate_blake3_hash_with_empty_inner_signature() {
    ...
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.shinkaimessagewrapper_calculate_blake3_hash_with_empty_inner_signature(
        retptr,
        this.__wbg_ptr
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
...
export class ShinkaiStringTime {
  ...
  static generateSpecificTime(year, month, day, hr, min, sec) {
    ...
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.shinkaitime_generateSpecificTime(
        retptr,
        year,
        month,
        day,
...
export function __wbg_require_8f08ceecec0f4fee() {
...
export function __wbg_getRandomValues_37fa2ca9e4e07fab() {
...
export function __wbg_newwithbyteoffsetandlength_6da8e527659b86aa(
  arg0,
  arg1,
  arg2
) {
