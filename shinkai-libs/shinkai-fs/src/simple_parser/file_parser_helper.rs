...
impl ShinkaiFileParser {
    ...
    /// Split a string at the nearest whitespace boundary, producing chunks.
        ...
        while start < text.len() {
            let end = {
                ...
                if candidate_end >= text.len() {
                    ...
                    // Walk backward until whitespace
    ...
    /// Same as `split_into_chunks`, but also avoids splitting in the middle of metadata.
        ...
        while start < text.len() {
            let end = {
                ...
                if candidate_end >= text.len() {
                    ...
                    // Walk backward until whitespace or we exit a metadata block
