...
// use crate::{shinkai_fs_error::ShinkaiFsError, simple_parser::{file_parser_helper::ShinkaiFileParser,
// text_group::TextGroup}};

// use super::LocalFileParser;

// impl LocalFileParser {
//     pub fn process_md_file(file_buffer: Vec<u8>, max_node_text_size: u64) -> Result<Vec<TextGroup>, ShinkaiFsError> {
//         let md_string = String::from_utf8(file_buffer).map_err(|_| ShinkaiFsError::FailedMDParsing)?;
