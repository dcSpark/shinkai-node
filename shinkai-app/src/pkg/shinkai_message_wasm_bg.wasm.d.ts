...
export function shinkaimessagebuilderwrapper_body(a: number, b: number, c: number, d: number): void;
...
export function shinkaimessagebuilderwrapper_use_code_registration(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number): void;
...
export function shinkaimessagewrapper_body(a: number, b: number): void;
export function shinkaimessagewrapper_set_body(a: number, b: number, c: number): void;
