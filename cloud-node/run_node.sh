...
export SHINKAI_TOOLS_RUNNER_DENO_BINARY_PATH=${SHINKAI_TOOLS_RUNNER_DENO_BINARY_PATH:-"/app/shinkai-tools-runner-resources/deno"}
export SHINKAI_TOOLS_RUNNER_UV_BINARY_PATH=${SHINKAI_TOOLS_RUNNER_UV_BINARY_PATH:-"/app/shinkai-tools-runner-resources/uv"}
