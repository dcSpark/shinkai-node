...
//     // TODO: implement a vector search endpoint for finding FSItems (we'll need for the search UI in Visor for the
// FS) and one for the VRKai returned too     pub async fn api_vec_fs_retrieve_vector_search_simplified_json(
//         _db: Arc<SqliteManager>,
//         node_name: ShinkaiName,
//         identity_manager: Arc<Mutex<IdentityManager>>,
//         encryption_secret_key: EncryptionStaticKey,
