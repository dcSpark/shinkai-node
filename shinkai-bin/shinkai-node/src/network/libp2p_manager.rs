...
pub enum NetworkEvent {
    ...
    SendDirectMessage { peer_id: PeerId, message: ShinkaiMessage },
...
impl LibP2PManager {
        ...
        let mut swarm = libp2p::SwarmBuilder::with_existing_identity(local_key)
            ...
            .with_behaviour(|keypair, relay_behaviour| ShinkaiNetworkBehaviour {
                ...
                identify: identify::Behaviour::new(
                    identify::Config::new("/shinkai/1.0.0".to_string(), keypair.public())
    ...
    async fn handle_swarm_event(
        ...
        match event {
            ...
            SwarmEvent::Behaviour(ShinkaiNetworkBehaviourEvent::Identify(identify::Event::Received {
                peer_id,
                info,
                ..
            })) => {
                ...
                if supports_relay {
                    ...
                    let supports_shinkai = info
                        .protocols
                        .iter()
                        .any(|protocol| protocol.to_string().contains("/shinkai/message/"));
                    ...
                    if supports_shinkai {
                        shinkai_log(
                            ...
                            ShinkaiLogLevel::Info,
                            &format!(
                                "✅ Peer {} supports Shinkai message protocol - ready for communication",
                                peer_id
                            ),
                        );
                    } else {
